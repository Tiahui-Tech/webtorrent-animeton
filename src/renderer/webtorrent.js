...
function init() {
  ...
  ipcRenderer.on(
    'wt-start-torrenting',
    (e, torrentKey, torrentID, path, fileModtimes, selections) =>
...
function listenToClientEvents() {
  client.on('warning', (err) =>
    ipcRenderer.send('wt-warning', null, err.message)
  );
