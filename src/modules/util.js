...
const sleep = t => new Promise(resolve => setTimeout(resolve, t).unref?.())
...
function generateRandomHexCode (len) {
  let hexCode = ''
...
module.exports = { chunks, defaults, DOMPARSER}